module RoomsHelper
	...
	def description_room(type)
		case type
			...
			when Room::ROOMS111
				'Třípokojový apartmán o výměře 65m2 s kapacitou 6 osob je složen s dvou samostatných pokojů a podkroví. Jeden pokoj slouží jako společenská místnost, která je vybavena TV, kuchyňským koutem vybaveným jednoplotýnkovým indukčním vařičem, rychlovarnou konvicí, lednicí a mikrovlnou troubou. Druhý sousedící pokoj je vybaven postelí po 2 osoby s přímou možností vstupu do sociálního zařízení, které je vybaveno rohovou masážní vanou.Do sociálního zařízení lze také vstoupit s chodby. Dřevěným schodištěm ze společenské místnosti se dostanete do podkorový, které je vybaveno postelí pro 2 osoby, samostatnou postelí a matrací která slouží jako přistýlka.' 
			when Room::ROOMS112
