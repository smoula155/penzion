module RoomsHelper
	...
	def description_room(type)
		case type
			...
			when Room::ROOMS112
				'Dvoupokojový apartmán o výměře 32m2 s kapacitou 5 osob se skládá s pokoje vybaveným TV, kuchyňským koutem vybaveným jednoplotýnkovým indukčním vařičem, rychlovarnou konvicí, lednicí,mikrovlnou troubou a také rozkládací pohovkou s možností přespání dvou osob. S tohoto pokoje se dřevěným schodištěm dostanete do podkoroví, které je vybaveno třemi samostatnými postelemi. Samozřejmostí je vlastní sociální zařízení s masážní vanou.'
			when Room::ROOMS109110
